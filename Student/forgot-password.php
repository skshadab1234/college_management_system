...
<div class="form-inner">
  <form class="login" method="post" id="signupForm">
    <div class="field">
      <input type="email" placeholder="Email id" id="email_id_student" required>
    </div>
    <div class="field btn">
    <div class="btn-layer">
    </div>
  ...
  <script type="text/javascript" src="../assets/js/dark-light-mode.js"></script>
      <script type="text/javascript">
       jQuery(document).ready(function(){
            ...
            var email_id_student = jQuery('#email_id_student').val();
            var forgotpass = 'forgotpass';

            jQuery('#submit_form').attr('disabled',true);
            jQuery('#submit_form').val("Wait.....");
            if(re.test(email_id_student)){
               jQuery.ajax({
                url:"../verify.php",
                type:"post",
                data: {
                    email_id_student:email_id_student,
