          ...
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
              ...
              <tr>
                  <td style="padding:0 35px;">
                      ...
                      <a href="'.FRONT_SITE_PATH_STUDENT.'change_password'.PHP_EXT.'?email_id='.$email_id_student.'&reset-code='.$row['reset_password_code'].'"
...
$arr=array('status'=>'error_account');
echo json_encode($arr); 
}
}
          ...
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
              ...
              <tr>
                  <td style="padding:0 35px;">
                      ...
                      <a href="'.FRONT_SITE_PATH_TEACHER.'change_password'.PHP_EXT.'?email_id='.$email_id_faculty.'&reset-code='.$row['reset_password_code_faculty'].'"
                          style="background:#20e277;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Reset
                          Password</a>
                  </td>
              </tr>
