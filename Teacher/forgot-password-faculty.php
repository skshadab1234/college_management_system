...
<div class="form-inner">
  <form class="login" method="post" id="signupForm">
    <div class="field">
      <input type="email" placeholder="Email id" id="email_id_faculty" required>
    </div>
    <div class="field btn">
    <div class="btn-layer">
    </div>
  ...
  <script type="text/javascript" src="../assets/js/dark-light-mode.js"></script>
      <script type="text/javascript">
       jQuery(document).ready(function(){
            ...
            var email_id_faculty = jQuery('#email_id_faculty').val();
            ...
            if(re.test(email_id_faculty)){
               jQuery.ajax({
                url:"../verify.php",
                type:"post",
                data: {
                    email_id_faculty:email_id_faculty,
